  ...
  return (
    <>
      <header className="landing-header">
        ...
        <div>
          <Link className="landing-header__sign-in" to={"/login"}>
            Sign In
          </Link>
          <Link to={`/signup`}>
      ...
      <section className="top-section">
        <h1 className="top-section__title">
          ...
          <span className="top-section__highlight">adipiscing elit.</span>
        </h1>
        ...
        <img
          className="top-section__screenshot"
          src={coverterScreenshot}
          alt="Converter Screenshot"
        />
      </section>
      <section className="bank-section">
        <h2 className="bank-section__title">
      ...
      <section className="award-section">
        ...
        <div className="award-section__features-container">
          <Feature
            ...
            desc={
              "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cursus nibh sit eu sagittis."
            }
          />
          <Feature
            title={"Lorem ipsum dolor sit amet."}
        ...
        <Button buttonClass="invertedButton" buttonText={"Find out More"} />
      </section>
      <section className="conversion-section">
        <h2 className="conversion-section__title">Make A Conversion</h2>
        <p className="conversion-section__text">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut id
          fringilla augue feugiat. Volutpat tortor ornare lectus praesent amet.
        </p>
        <img
          className="conversion-section__screenshot"
          src={convertAmountScreenshot}
          alt="Convert amount screenshot"
        />
      </section>
      <section className="rates-section">
        <h2 className="rates-section__title">View latest rates</h2>
        <p className="rates-section__text">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut id
          fringilla augue feugiat. Volutpat tortor ornare lectus praesent amet.
        </p>
        <img
          className="rates-section__screenshot"
          src={ratesScreenshot}
          alt="Rates screenshot"
        />
      </section>

...
const BankContact = ({
  ...
  return (
    <div className="bank-contact">
      ...
      <p
        className={
          isTransfer ? "bank-contact__bank hide" : "bank-contact__bank"
        }
      >
        {bank}
      </p>
      <p
        className={
          isTransfer ? "bank-contact__iban hide" : "bank-contact__iban"
        }
      >
        {iban}
      </p>
      <img
        className={isTransfer ? "bank-contact__bin hide" : "bank-contact__bin"}
        src={bin}
        alt="bin"
      />
    </div>
